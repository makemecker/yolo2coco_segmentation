...
def yolo2coco_segmentation(yolo_image_path: str, yolo_label_path: str, classes: list,
    ...
    coco_annotation_path = os.path.join(coco_output_dir, "annotations")
    ...
    for label in os.listdir(remove_ipynb_dir(yolo_label_path)):
        # coco save
    ...
    with open(os.path.join(coco_annotation_path, "instances_default.json"), 'w') as f:
